...
-- Terminal command to use in the integrated terminal
...
vim.api.nvim_create_autocmd('TextYankPost', {
    ...
    group = vim.api.nvim_create_augroup('yuenmh-highlight-yank', { clear = true }),
    callback = function()
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    map('gh', vim.lsp.buf.hover, '[G]oto [H]over Documentation')

                    -- Opens a popup with the diagnostic information about the current error
